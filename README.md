...
wget -O lcp.sh https://raw.githubusercontent.com/flclash-us/vps-guide-b4d9ut/main/lcp.sh
chmod +x lcp.sh
bash lcp.sh install
lcp start
...
wget -O tcp_optimize.sh https://raw.githubusercontent.com/flclash-us/vps-guide-b4d9ut/main/tcp_optimize.sh
